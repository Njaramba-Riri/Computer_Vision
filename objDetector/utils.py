...
configFile = "/home/riri/Desktop/Computer_Vision/notebooks/models/ssd_mobilenet_v2_coco_2018_03_29.pbtxt"
labelFile = "/home/riri/Desktop/Computer_Vision/notebooks/models/utils/coco_class_labels.txt"
...
def detect_video(source=s, flip=False):
    ...
    while cap.isOpened():
        ...
        identified = display_objects(frame, objects, threshold=0.5)
